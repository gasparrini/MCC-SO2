...
setwd("H:/Sera/MCC/MCC-SO2/CoPollutant_models/PM25")
...
citiesso2<-infopoll$so2==TRUE & infopoll$pm25==TRUE
...
subcountry <- cities$country %in% sort(c("aus8809","can8615",
  "chi9615","est9715","fnl9414","ger9315",
  "jap1115","por8018","rom9416","spa9014","sui9513",
  "twn9414","uk9016Poll", "usa7306"))
