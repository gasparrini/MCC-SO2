...
setwd("H:/Sera/MCC/MCC-SO2/CoPollutant_models/PM10")
...
citiesso2<-infopoll$so2==TRUE & infopoll$pm10==TRUE
...
subcountry <- cities$country %in% sort(c("aus8809","bra9711","can8611",
